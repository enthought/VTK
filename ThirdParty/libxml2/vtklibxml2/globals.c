 ...
 */
void *vtk_libxml2_xmlStructuredErrorContext = NULL;
...
#define xmlStructuredErrorContext vtk_libxml2_xmlStructuredErrorContext
...
__xmlStructuredErrorContext(void) {
    if (IS_MAIN_THREAD)
	return (&vtk_libxml2_xmlStructuredErrorContext);
    else
